            ...
            {categoryBlogs?.map((item) => (
              <li className="mt-10 " key={category.id}>
                ...
                >
                  <div
                    key={item.id}
                    className="w-96 bg-white hover:bg-gradient-to-r hover:scale-105  hover:from-orange-400 hover:to-rose-400 transition duration-300 ease-in-out  rounded-xl p-2 shadow "
                  >
