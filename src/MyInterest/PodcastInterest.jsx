    ...
    <div>
      <Helmet>
        ...
        <meta
          ...
          content={interestPosts
            .map((interest) => interest.podcastName)
            .join(", ")}
        />
        <meta
          name="keywords"
        ...
        <meta
          name="url"
          content="https://wholesome.crystaleey.com/myinterest/podcast"
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="article" />
        <link
          rel="canonical"
          href="https://wholesome.crystaleey.com/myinterest/podcast"
        />
        ...
        <script
          ...
          {...JSON.stringify({
            ...
            url: "https://wholesome.crystaleey.com/myinterest/podcast",
      ...
      <div className="py-32  flex flex-wrap px-20 sm:w-full sm:px-5  gap-4  justify-center">
        {interestPosts?.map((item) => (
          <div key={item.key} className="flex flex-col gap-4 bg-gray-800 h-56 ">
            ...
            <div className="px-5">
              <audio className="w-full h-10 " src={item.audioUrl} controls />
            </div>
          </div>
        ))}
      </div>
