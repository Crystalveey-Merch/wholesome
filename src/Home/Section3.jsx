...
const Section3 = () => {
  ...
  return (
    <div className="bg-white">
      <h1 className=" text-xl  py-5 text-center text-red-500 Aceh text-md">
        COMMUNITY SPOTLIGHT
      </h1>
      <hr></hr>
      <Swiper
          ...
          <SwiperSlide key={user.id}>
            <div className=" flex w-auto sm:flex-col gap-4  p-10 m-auto justify-center">
              ...
              <div className="h-full flex flex-col  gap-2">
                <h1 className="text-black text-xl sm:text-center">
                  {user.name}
                </h1>
                <p className="text-black w-64 text-red-500 sm:text-center">
