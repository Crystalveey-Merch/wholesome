...
const RepliesComment = ({ name, body, createdAt, msg, isAuthUserComment, imgUrl, commentLikes }) => {
  return (
    <div>
        ...
        <div className="comments-list">
          <div className="media dark:text-red-300">
            {msg ? (
              ...
              <>
                <div className={isAuthUserComment ? "right  m-2 " : "left  m-2 w-fit  "}>
                  ...
                  />
                    ...
                    <div className= {isAuthUserComment? "chat chat-start  ":"chat chat-start  w-full "}>
                      <div className="flex">
                    <div className={isAuthUserComment ? "chat-bubble flex text-white    Aceh bg-red-500  " : "chat-bubble text-white chat-start Aceh bg-sky-800 flex gap-5  sm:gap-4 my-auto w-full "}>
