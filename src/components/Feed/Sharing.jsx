          ...
          <>
            <Popover.Button
              className={`
                ...
                group inline-flex items-center rounded-md hover:text-gray-600 focus:outline-none`}
            >
                  ...
                  <div className="relative flex flex-col gap-1 bg-white p-2">
                    {/* {shares.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="-m3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-gray-50 focus:outline-none"
                      >
                        <div className="flex shrink-0 items-center justify-center">
                          <FontAwesomeIcon
                            icon={item.icon}
                            className={`h-5 w-5 ${item.color} bg-white`}
                          />
                        </div>
                        <div className="ml-4">
