    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content={`View contents based on ${interestName}`}
        />
        <meta
          name="keywords"
        ...
        <meta
          name="url"
          content={`https://wholesome.crystaleey.com/interest/${interestName}`}
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="article" />
        <link
          rel="canonical"
          href={`https://wholesome.crystaleey.com/interest/${interestName}`}
        />
        ...
        <script
          ...
          {...JSON.stringify({
            ...
            url: `https://wholesome.crystaleey.com/interest/${interestName}`,
      ...
      <div className="mt-20 w-screen  sm:mt-18 bg-gray-100 ">
        <div className="bg-gradient-to-r from-indigo-300 to-purple-400 w-screen">
          <h1 className="text-white text-center uppercase Aceh text-3xl sm:text-2xl py-10">
            {interestName}
          </h1>
        </div>
        <div className="flex justify-center  sm:flex-col">
          <div>
            <div className="py-5">
              <h1 className=" text-gray-500 text-xl  capitalize text-center py-5">
        ...
        <div className="py-5">
          <h1 className=" text-gray-500 text-xl  capitalize text-center my-5">
            Community Activity
          </h1>
          <hr></hr>
        </div>
                    ...
                    <NavLink to={`/activity/${activity.id}`}>
                      <div className="relative w-72  bg-gray-800 rounded-xl  shadow-xl  image-full">
                        ...
                        <div className="p-5 bg-base-500">
                          <p className="text-gray-100 flex  gap-4">
                            <FontAwesomeIcon icon={faLocationPin} />
                            {activity.location}{" "}
                          </p>
                          <p className="text-gray-100 flex  gap-4  ">
                            ...
                            />{" "}
                            {activity.claps} Claps
                          </p>
                          <div className="badge text-gray-200 bg-gray-600 p-4 my-3 flex gap-4 ">
                            {" "}
                            <FontAwesomeIcon icon={faCalendar} />{" "}
                            {Moment(activity.DateTime).format("DD-MM-YYYY")} -{" "}
                            {Moment(activity.DateTime).format(" hh:mm a")}
                          </div>
                          <h1 className="text-2xl py-2 text-gray-200">
                            {" "}
