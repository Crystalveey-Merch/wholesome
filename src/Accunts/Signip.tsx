...
const Signip = () => {
    ...
    const handleSelect = (selectedOption) => {
      ...
      const handleRemove = (removedOption) => {
        const updatedOptions = selectedOptions.filter((option) => option.key !== removedOption.key);
        ...
        <div key={option.key}>{option.key}</div>)
                                            ...
                                            <form
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Email"
                                                />
                                                <label className="text-sm text-gray-400">Select at least 2 interests</label>
                                                <Multiselect
                                                ...
                                                <span className="flex  gap-2 mb-4 border-grey-light bg-gray-100 w-full  rounded">
                                                    ...
                                                    >
                                                        {showPassword ? (
                                                            <FontAwesomeIcon icon={faEye} className="text-red-500 text-sm" />) : (

                                                            <FontAwesomeIcon icon={faEyeSlash} className="text-red-500 text-sm" />)}
                                                    </div>
                                                </span>
                                                ...
                                                />
                                                {passwordMatch ? (
                                                    <div className="text-green-500 text-left text-sm">Passwords match</div>
                                                ) : (
                                                    <div className="text-red-500 text-left text-sm">Passwords do not match</div>
                                                )}
                                                <div className="form-control">
                                                    <label className="label cursor-pointer">
                                                        <span className="label-text text-green-500">Remember me</span>
