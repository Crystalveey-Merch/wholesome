...
import { ReplyChatBoxModal2, ReplyUnderParent } from ".";
  ...
  return (
    <div>
      ...
      {currentChatBox?.id === reply.id ? (
        <div className="flex flex-col pt-1.5 pb-1.5 gap-0 px-1.5">
          ...
          <div className="flex flex-col gap-1 py-2">
            {" "}
            <div className="text-black font-inter font-medium text-base">
