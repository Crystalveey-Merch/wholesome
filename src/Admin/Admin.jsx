...
import { faBookmark, faMicrophone, faMicroscope, faRunning, faSave, faSignOut, faUser } from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="drawer drawer-open">
              ...
              <div className="drawer-side">
                  ...
                  <ul className="menu p-4 w-80 min-h-full bg-gray-200 text-base-content sm:hidden">
                      ...
                      <li><NavLink to='podcasts'className="text-black">Podcasts</NavLink></li>
                      <li><NavLink to='activities'className="text-black">Activities</NavLink></li>
