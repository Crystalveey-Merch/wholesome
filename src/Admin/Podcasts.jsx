...
const Podcasts = () => {
    ...
    const deletepodcast = async (podcast) => {
        if (window.confirm("Are you sure you want to delete this Podcast?")) {
          try {
            ...
            const updatedPosts = podcast.filter((post) => post.postId !== podcast.id);
  ...
  return (
    <div>  <div className="py-10 sm:px-2 px-8 w-full ">
                ...
                <tbody key={podcast.id} >
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th scope="row" className="px-6 py-4 font-medium Aceh  text-gray-900 whitespace-nowrap dark:text-white">
                            <img src={podcast.photoURL} className="w-10 h-10 rounded-full"></img>
                        </th>
                        ...
                        <td className="px-6 py-4 text-right">
                            <button type="button" onClick={() => deletepodcast(podcast)} className=" block font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete podcast</button>
